...
export const heroResponsive: ResponsiveWidth[] = [
	{ src: '/images/combat-master-hacks-hero-640w.webp', width: 640 },
	{ src: '/images/combat-master-hacks-hero-1024w.webp', width: 1024 },
	{ src: '/images/combat-master-hacks-hero-1536w.webp', width: 1536 },
];

export const heroDesktopResponsive: ResponsiveWidth[] = heroResponsive;

/** Default LCP src — mid ladder WebP (~56KB). */
export const heroSrc = '/images/combat-master-hacks-hero-1024w.webp';
...
/** Exact native dimensions (no zoom crop). Hero source ~1983×793 (~2.5:1). */
export const heroWidth = 1024;
export const heroHeight = 410;
