...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
		...
		sections: [
			{
				h2: 'ESP & wallhack',
				paragraphs: [
					'See enemy players, enemy players, bosses, and loot through walls with distance readouts.',
			...
			},
			{
				...
				list: ['Nearby enemy cues', 'Adjustable range', 'Works in Multiplayer & ranked'],
			},
			{
				h2: 'Updates & support',
				paragraphs: [
		...
		sections: [
			{
				h2: 'Current status',
				paragraphs: [
					'As of 13 Aug 2026 the package is online for Combat Master on Windows PC. We post a new note here when a game or Anti-cheat patch needs a rebuild.',
		...
		sections: [
			{
				h2: 'What you get',
				paragraphs: [
					'One license for Combat Master on Windows PC — built for multiplayer matches and ranked modes.',
				],
				list: [
			...
			},
			{
				...
				paragraphs: [
					'Read enemy players before you push, mark loot worth the risk, and stay aware near extracts. Tune soft aim per weapon class for dorms, Factory, and long-range maps.',
				],
				list: [
					'<a href="/combat-master-esp/">ESP guide</a>',
					'<a href="/combat-master-aimbot/">Aimbot controls</a>',
					'<a href="/combat-master-radar-hack/">Radar overlay</a>',
	...
	'combat-master-esp': page({
		...
		sections: [
			{
				h2: 'What ESP shows',
				paragraphs: ['Boxes, distance, and filters for enemy players, enemy players, bosses, and loot.'],
			...
			},
			{
				...
				list: [
					'<a href="/combat-master-hacks/">Full product</a>',
	...
	radar: page({
		...
		description:
			'Combat Master 2D radar for Combat Master on Windows PC — flank cues near extracts without filling the whole screen.',
		h1: 'Radar',
		...
		sections: [
			{
				h2: 'What it shows',
				paragraphs: ['Nearby enemy cues with adjustable range for PMC and ranked matches.'],
