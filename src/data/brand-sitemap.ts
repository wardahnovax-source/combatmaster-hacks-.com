...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'combat master hacks esp',
		caption: 'combat master hacks esp wallhack',
	},
	{
		src: '/images/combat-master-hacks-wallhack.webp',
		title: 'combat master hacks wallhack',
		caption: 'combat master hacks wallhack esp',
	},
	{
		src: '/images/combat-master-hacks-aimbot.webp',
		title: 'combat master hacks aimbot',
		caption: 'combat master hacks aimbot soft aim',
	},
	{
		src: '/images/combat-master-hacks-aimbot-view.webp',
		title: 'combat master hacks aimbot',
		caption: 'combat master hacks aimbot view',
	},
	{
		src: '/images/combat-master-hacks-radar.webp',
		title: 'combat master hacks radar',
		caption: 'combat master hacks radar hack',
	},
	{
		src: '/images/combat-master-hacks-match.webp',
		title: 'combat master hacks',
		caption: 'combat master hacks in match',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	...
	'combat-master-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'combat-master-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	updates: { title: '{primaryKeyword} live status', caption: 'Check {primaryKeyword} after a game or Anti-cheat patch' },
	...
	'anti-cheat': { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a Anti-cheat update' },
