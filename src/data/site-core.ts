...
export const productInfo = {
	...
	features: {
		esp: [
			'Player ESP overlay',
			'Enemy player tags and distance',
			'Through-wall visibility',
			'Team and threat filters',
			'Toggleable ESP categories',
			'Name and health readouts',
		],
		aimbot: [
			'Aimbot and aim assist controls',
			'No recoil and spread control',
			'Smoothness and FOV settings',
			'Bone priority and aim lock',
			'Per-weapon profiles',
		],
		radar: [
			'Radar minimap overlay',
			'Enemy player radar',
			'Adjustable range and scale',
			'Works in all match modes',
		],
		general: [
			'Killstreak feature tools',
