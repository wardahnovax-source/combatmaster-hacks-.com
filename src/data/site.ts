...
export const seoLandingPages = [
	{ label: fillBrandTokens('{game} hacks'), href: '/combat-master-hacks/' },
	{ label: fillBrandTokens('{primaryKeyword}'), href: '/combat-master-hacks/' },
	{ label: fillBrandTokens('{game} esp'), href: '/combat-master-esp/' },
	{ label: fillBrandTokens('{game} aimbot'), href: '/combat-master-aimbot/' },
	{ label: fillBrandTokens('{game} setup'), href: '/setup/' },
	{ label: fillBrandTokens('Undetected {primaryKeyword}'), href: '/combat-master-hacks/' },
	{ label: fillBrandTokens('{game} wallhack'), href: '/combat-master-esp/' },
	{ label: fillBrandTokens('{game} radar hack'), href: '/combat-master-radar-hack/' },
] as const;

export const mainNav = [
	{ label: 'Home', href: '/' },
	{ label: 'Cheats', href: '/combat-master-hacks/' },
	{ label: 'Aimbot', href: '/combat-master-aimbot/' },
	{ label: 'ESP', href: '/combat-master-esp/' },
...
export const footerExplore = [
	...
	{ label: fillBrandTokens('{game} hacks pillar'), href: '/combat-master-hacks/' },
	{ label: fillBrandTokens('Live {game} status'), href: '/updates/' },
	{ label: fillBrandTokens('{game} ESP overlays'), href: '/combat-master-esp/' },
	{ label: fillBrandTokens('{game} Aimbot controls'), href: '/combat-master-aimbot/' },
	{ label: fillBrandTokens('{game} radar hack'), href: '/combat-master-radar-hack/' },
...
export const homeFaqs: readonly FaqItem[] = [
	faq({
		...
		answer:
			'{brand} is an undetected {primaryKeyword} package for Combat Master on Windows PC. It includes ESP wallhack, 2D radar, and aimbot controls, with {antiCheat} maintenance and setup support.',
		slug: 'what-are-combat-master-hacks',
	...
	faq({
		...
		slug: 'are-combat-master-hacks-undetected-in-2026',
	...
	faq({
		question: 'Does this work in multiplayer matches and ranked modes?',
		answer:
			'Yes. ESP, radar, and aimbot are built for {game} match flow — reading enemy players, spotting loot, and staying aware near extracts.',
		slug: 'pmc-matchs-and-scav-runs',
		seoTitle: 'PMC Raid and Scav Support | FAQ',
		seoDescription:
			'{brand} works in multiplayer matches and ranked modes — ESP, radar, and aimbot for Windows PC.',
	}),
	faq({
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'A {game} wallhack is an ESP overlay that shows enemy players, enemy players, and loot through walls. {brand} includes distance readouts, extract cues, and toggleable categories.',
		slug: 'what-is-a-combat-master-wallhack',
		seoTitle: 'What Is a {game} Wallhack? | FAQ',
		seoDescription:
			'A {game} wallhack is ESP that reveals enemy players, enemy players, and loot through walls — with distance, extracts, and category toggles.',
	}),
	faq({
		...
		slug: 'does-combat-master-hacks-include-radar-hack',
	...
	faq({
		...
		slug: 'anti-cheat-anti-cheat-and-combat-master-hacks',
	...
	faq({
		...
		slug: 'buy-undetected-combat-master-hacks-windows-pc',
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Combat Master Hacks feels smooth on Customs. The menu took a few minutes to learn. After that, matchs felt easy.',
		short: 'Soft aim in Combat Master Hacks feels smooth on Customs.',
		slug: 'combat-master-no-recoil-review-xkrypt0',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on ranked matches. You can see who is holding a hallway before you push. Still worth the price for Combat Master Hacks.',
		short: 'ESP boxes help on ranked matches. Still worth the price for Combat Master Hacks.',
		slug: 'combat-master-esp-scav-run-review-buildsr4k',
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Combat Master Hacks this wipe. Setup was simple. It stayed up after the last Anti-cheat update when my old cheat failed. Lifetime was a good buy.',
		short: 'Combat Master Hacks stayed up after the last Anti-cheat update. Lifetime was a good buy.',
		slug: 'combat-master-cloud-dma-review-dma-wizard',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Combat Master Hacks is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Combat Master Hacks is easy to tune on PC.',
		slug: 'combat-master-no-recoil-review-ctrl-player99',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Combat Master Hacks works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
		short: 'ESP on Woods is solid. Support helped after a slow first launch.',
		slug: 'combat-master-cheat-setup-review-stormchaser07',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Combat Master Hacks pays for the monthly plan. Extract markers and distance make early matchs faster.',
		short: 'Loot ESP in Combat Master Hacks pays for the monthly plan.',
		slug: 'combat-master-loot-esp-review-lootgoblinx',
		seoTitle: 'Loot ESP Review by @lootGoblinx — 5/5 | {brand}',
		seoDescription: '@lootGoblinx rates {brand} loot ESP 5/5 for early matchs on Windows PC.',
		date: '2026-08-01',
	}),
	reviewMeta({
		handle: 'rankedGrind42',
		rating: 4,
		text: 'I have used Combat Master Hacks since last wipe. Soft aim per weapon helps in dorms. Status updates after Anti-cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Combat Master Hacks helps in dorms.',
		slug: 'combat-master-no-recoil-match-review-rankedgrind42',
		seoTitle: 'Raid Soft Aim by @rankedGrind42 — 4/5 | {brand}',
		seoDescription: '@rankedGrind42 rates {brand} soft aim 4/5 for matchs on Windows PC.',
		date: '2026-07-07',
		tag: 'Raid',
	}),
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Combat Master Hacks saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Combat Master Hacks saved me near extracts.',
		slug: 'combat-master-radar-hack-review-vanlifeeft',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Combat Master Hacks posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Combat Master Hacks was back the next morning after a patch.',
		slug: 'combat-master-anti-cheat-update-review-patchdaymike',
		...
		date: '2026-06-09',
		tag: 'Anti-cheat updates',
	}),
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Combat Master Hacks is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Combat Master Hacks is excellent.',
		slug: 'combat-master-sniper-soft-aim-review-snipezonly',
