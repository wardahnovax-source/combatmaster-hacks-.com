	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/combat-master-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/combat-master-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/combat-master-radar-hack/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/combat-master-hacks/', labelKey: 'homeSeo.linkUndetected' },
