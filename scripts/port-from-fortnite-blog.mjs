#!/usr/bin/env node
/**
 * Ports the 8 posts from ../combat-master-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'combat-master-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'combat-master intel'],
...
const file = `/* Auto-generated by scripts/port-from-combat-master-blog.mjs — do not edit by hand. */
