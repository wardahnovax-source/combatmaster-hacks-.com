...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/combat-master-hacks-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/combat-master-hacks-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/combat-master-hacks-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/combat-master-hero-banner.webp');
