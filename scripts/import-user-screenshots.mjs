...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-combat-masterhacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'combat-master-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'combat-master-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'combat-master-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'combat-master-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'combat-master-esp-radar.webp',
	},
	{
		source:
		...
		file: 'combat-master-hacks-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'combat-master-battle-royale-combat',
	'combat-master-extract-fight',
	'combat-master-hacks-aimbot',
	'combat-master-hacks-cover',
	'combat-master-hacks-esp-wallhack',
	'combat-master-hacks-hero',
	'combat-master-hacks-logo',
	'combat-master-hacks-package',
	'combat-master-header-art',
	'combat-master-loadout-builder',
	'combat-master-player-esp',
	'combat-master-scav-run-combat',
	'combat-master-scav-run-mode',
	'combat-master-squad-fight',
	'combat-master-verdansk-map',
];
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'combat-master-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `combat-master-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'combat-master-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'combat-master-hacks-logo.png');
